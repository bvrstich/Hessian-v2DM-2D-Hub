...
/**
 * Initialization of the SUP matrix Z, is just u^0: see primal_dual.pdf for more information
 */
void SUP::init_Z(){
...
/**
 * Initialisation for dual SUP matrix X, see primal_dual.pdf for info.
 */
void SUP::init_X(double alpha,const TPM &ham,const SUP &u_0){
   ...
   //nog een eenheidsmatrix maal constante bijtellen zodat X positief definiet is:
